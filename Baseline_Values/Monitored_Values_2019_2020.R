...
# Without Uncertainty
MonitoredValues$year1$FPlnVolHarvHwd <- 19801 # volume of hardwood harvested (m3) REAL DATA
...
MonitoredValues$year1$FPlnAreaHarvHwd <- 135 # Area harvested during the yr (hardwood) REAL DATA
MonitoredValues$year1$FPlnAreaJustGrowsHwd <- MonitoredValues$year1$FPlnAreaStockHwd - MonitoredValues$year1$FPlnAreaHarvHwd
MonitoredValues$year1$FPlnVolHarvSwd <- 386985 # volume of softwood harvested (m3) REAL DATA
MonitoredValues$year1$FPlnAreaStockSwd <- 24698 # Existing stock at start of yr (softwood) REAL DATA
MonitoredValues$year1$FPlnAreaPlantSwd <- 2008 # Area planted during the yr (softwood) REAL DATA
MonitoredValues$year1$FPlnAreaHarvSwd <- 909 # Area harvested during the yr (softwood) REAL DATA
...
# Without Uncertainty
MonitoredValues$year2$FPlnVolHarvHwd <-  21441 # volume of hardwood harvested (m3) REAL DATA 
...
MonitoredValues$year2$FPlnAreaHarvHwd <- 143 # Area harvested during the yr (hardwood) REAL DATA
MonitoredValues$year2$FPlnAreaJustGrowsHwd <- MonitoredValues$year1$FPlnAreaStockHwd - MonitoredValues$year1$FPlnAreaHarvHwd
MonitoredValues$year2$FPlnVolHarvSwd <- 479959 # volume of softwood harvested (m3) REAL DATA
MonitoredValues$year2$FPlnAreaStockSwd <- 26094 # Existing stock at start of yr (softwood) REAL DATA
MonitoredValues$year2$FPlnAreaPlantSwd <- 1910 # Area planted during the yr (softwood) REAL DATA
MonitoredValues$year2$FPlnAreaHarvSwd <- 1377 # Area harvested during the yr (softwood) REAL DATA
