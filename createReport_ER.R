...
load("./Data/mrAuditMay24/fiji_frl_overall_years.RData")


load("./Data/mrAuditMay24/Fiji_ER_Estimate_AccuracyAssessment.RData")
rmarkdown::render(
  "./reports/Fiji_ER_Estimate_AccuracyAssessment.Rmd",
  output_dir = "./reports",
  output_format = "html_document")

load("./Data/mrAuditMay24/Fiji_ER_Estimate_Values.RData")
rmarkdown::render(
  "./reports/Fiji_ER_Estimate_Values.Rmd",
  output_dir = "./reports",
  output_format = "html_document")

load("./Data/mrAuditMay24/Fiji_ER_Estimate_UC.RData")
rmarkdown::render(
  "./reports/Fiji_ER_Estimate_UC.Rmd",
  output_dir = "./reports",
  output_format = "html_document")

load("./Data/mrAuditMay24/Fiji_ER_Estimate_Sensitivity.RData")
rmarkdown::render(
